...
class MaterialDialog extends Page<void> {
  ...
  Route createRoute(BuildContext context) {
    ...
    return MaterialDialogRoute(
      barrierLabel: barrierLabel,
      barrierDismissible: barrierDismissible,
      barrierColor: barrierColor,
      transitionDuration: transitionDuration,
      pageBuilder: (context, animation, secondaryAnimation) {
        final dialog = themes.wrap(child);
        return dialog;
      },
...
class MaterialDialogRoute<T> extends PopupRoute<T> {
  @override
  final bool barrierDismissible;
  @override
  final Color barrierColor;
...
abstract class TransitionRoute<T> extends OverlayRoute<T> {
  ...
  bool get finishedWhenPopped =>
      _controller!.status == AnimationStatus.dismissed && !_popFinalized;

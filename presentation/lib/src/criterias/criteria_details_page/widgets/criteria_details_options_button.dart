...
class CriteriaDetailsOptionsButton extends StatelessWidget {
  const CriteriaDetailsOptionsButton({super.key});
      ...
      children: (context) => [
        MenuItem(
          ...
          onPressed: () {
            ...
            dispatch(OpenPageAction(Destination.editCriteria));
          },
        ),
        MenuItem(
            ...
            final approved = await navigator.push<bool>(
                  MaterialDialogRoute(
                    pageBuilder: (context, animation, secondaryAnimation) =>
                        ConfirmDeleteDialog(
                      subtitle:
                          Text(context.strings.youSureYouWantToDeleteCriteria),
                    ),

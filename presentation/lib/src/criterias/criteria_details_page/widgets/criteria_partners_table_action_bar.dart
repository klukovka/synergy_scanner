...
class CriteriaPartnersTableActionBar extends StatelessWidget {
  const CriteriaPartnersTableActionBar({super.key});

  @override
  Widget build(BuildContext context) {
    return StoreConnector(
      distinct: true,
      converter: TableViewModel<Partner, CriteriaTablePointer>.new,
        ...
        child: Row(
          children: [
            ...
            FilterButton(
              ...
              onPressed: () =>
                  viewModel.openPage(Destination.criteriaPartnersFilters),
            ),
          ],
        ),
      ),
